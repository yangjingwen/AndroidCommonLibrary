package com.andme.common.library.upload;
...
import com.andme.common.library.R;
...
//	private final static String TAG = "YJW";
	...
	public AsyncUploadTask(Context context,String url) {
		super();
...
//				StringBody param = new StringBody(paramValue.toString(),"");
				StringBody param = new StringBody(paramValue.toString(), Charset.forName("utf-8"));
